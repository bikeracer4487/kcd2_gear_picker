it("starts timer and runs callback when check passes", function()
...
it("restarts timer when check fails then succeeds", function()
...
function makeFactory(args)
    ...
    factory.runSpy = spy.new(function() end)
