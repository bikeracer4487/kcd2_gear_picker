describe("hasBathhouseBooking", function()
    it("truthy having a valid role for KCD1", function()
        ...
        local actual = factory
                .metaRole:hasBathhouseBooking(factory.entity)
...
function makeFactory(args)
    ...
    local bathhouse_kcd1 = args and args.metaRole == "bathhouse_kcd1"

    local system = mockSystem(mock, spy, { bathhouse_kcd1 = bathhouse_kcd1 })
